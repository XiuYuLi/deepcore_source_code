__global__ void dk_sfft8x8_r2c_perm2d( 
          float2*              d_c, 
...
__global__ void dk_sfft8x8_r2c_perm2d_ext( float2* d_c, 
    const float* __restrict__ d_r, const float* __restrict__ d_RF, 
    int nx, int ny, unsigned int ldc, unsigned int ldr, int n_cells )
{
    const int brev[]={0,2,1,3};
    __shared__ float smem[16*41];
    __shared__ float2 s_RF[4];
...
__global__ void dk_sfft8x8_r2c_perm2d_pad( float2* d_c, 
    const float* __restrict__ d_r, const float* __restrict__ d_RF, 
    int nx, int ny, unsigned int ldc, unsigned int ldr, int n_cells, int pad_x, int pad_y )
{
    const int brev[]={0,2,1,3};
    __shared__ float smem[16*41];
    __shared__ float2 s_RF[4];
...
__global__ void dk_sfft8x8_r2c_perm2d_flip( float2* d_c, 
    const float* __restrict__ d_r, const float* __restrict__ d_RF, 
    int nx, int ny, unsigned int ldc, unsigned int ldr, int n_cells )
{
    const int brev[]={0,2,1,3};
