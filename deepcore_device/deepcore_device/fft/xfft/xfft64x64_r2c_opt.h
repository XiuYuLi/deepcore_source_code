__global__ void dk_xfft64x64_r2c_s3( __half2* d_c, const __half* __restrict__ d_r, const float* __restrict__ d_RF )
{
...
#pragma unroll
    for( int i=0; i<33; ++i ){ d_c[i*64]=__float22half2_rn(c[i]); }
}
__global__ void dk_xfft64x64_r2c_s5( __half2* d_c, const __half* __restrict__ d_r, const float* __restrict__ d_RF )
{
    const int brev[]={0,16,8,24,4,20,12,28,2,18,10,26,6,22,14,30,1,17,9,25,5,21,13,29,3,19,11,27,7,23,15,31};
    __shared__ float smem[66*33];
    __shared__ float2 s_RF[32];
...
__global__ void dk_xfft64x64_r2c_s7( __half2* d_c, const __half* __restrict__ d_r, const float* __restrict__ d_RF )
{
    const int brev[]={0,16,8,24,4,20,12,28,2,18,10,26,6,22,14,30,1,17,9,25,5,21,13,29,3,19,11,27,7,23,15,31};
    __shared__ float smem[66*33];
    __shared__ float2 s_RF[32];
...
__global__ void dk_xfft64x64_r2c_flip_s3( __half2* d_c, const __half* __restrict__ d_r, const float* __restrict__ d_RF )
{
    const int brev[]={0,16,8,24,4,20,12,28,2,18,10,26,6,22,14,30,1,17,9,25,5,21,13,29,3,19,11,27,7,23,15,31};
    __shared__ float smem[66*33];
    __shared__ float2 s_RF[32];
...
__global__ void dk_xfft64x64_r2c_flip_s5( __half2* d_c, const __half* __restrict__ d_r, const float* __restrict__ d_RF )
{
    const int brev[]={0,16,8,24,4,20,12,28,2,18,10,26,6,22,14,30,1,17,9,25,5,21,13,29,3,19,11,27,7,23,15,31};
    __shared__ float smem[66*33];
    __shared__ float2 s_RF[32];
...
__global__ void dk_xfft64x64_r2c_flip_s7( __half2* d_c, const __half* __restrict__ d_r, const float* __restrict__ d_RF )
{
    const int brev[]={0,16,8,24,4,20,12,28,2,18,10,26,6,22,14,30,1,17,9,25,5,21,13,29,3,19,11,27,7,23,15,31};
    __shared__ float smem[66*33];
    __shared__ float2 s_RF[32];
