__global__ void dk_xfft8x8_r2c_perm3d( float2* d_c, 
...
__global__ void dk_xfft8x8_r2c_perm3d_ext( float2* d_c, 
    const __half* __restrict__ d_r, const float* __restrict__ d_RF, 
    unsigned int nx, unsigned int ny, unsigned int ldc, unsigned int ldr, int n_cells, int dir )
{
    const int brev[]={0,2,1,3};
...
__global__ void dk_xfft8x8_r2c_perm3d_pad( float2* d_c, 
    const __half* __restrict__ d_r, const float* __restrict__ d_RF, 
...
__global__ void dk_xfft8x8_r2c_perm3d_flip( float2* d_c, 
    const __half* __restrict__ d_r, const float* __restrict__ d_RF, 
    unsigned int nx, unsigned int ny, unsigned int ldc, unsigned int ldr, int n_cells, int dir )
{
    const int brev[]={0,2,1,3};
