#define xfft8x8_c2r_splice_perm(dir,suffix)        \
__global__ void dk_xfft8x8_c2r_splice_perm##suffix(\
          __half*              d_r   ,\
    ...
    s_load5( d, &smem[p*41+q], &smem[y*41+x], d_c, onc*ldc*8 );\
    s_hifft8( c, d, &smem[y*44], s_RF, brev, x );\
    s_vifft8( d, c, s_RF, brev, x );\
    bool bc=(icell<n)&&(flip_x<vax);\
    xfft8x8_c2r_store##suffix( d_r, d, d_x, alpha, bc, nx, vay );\
}

xfft8x8_c2r_splice_perm(-1,)
xfft8x8_c2r_splice_perm(-1,_relu)
xfft8x8_c2r_splice_perm( 0,_bias)
xfft8x8_c2r_splice_perm( 0,_bias_relu)
xfft8x8_c2r_splice_perm( 1,_drelu)
xfft8x8_c2r_splice_perm( 1,_xdrv)