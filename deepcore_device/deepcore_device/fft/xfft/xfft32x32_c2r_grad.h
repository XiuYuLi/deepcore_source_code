__global__ void dk_xfft32x32_c2r_grad( 
          __half*              d_r, 
...
__global__ void dk_xfft32x32_c2r_grad_s3( __half* d_r, const float2* __restrict__ d_c, const float* __restrict__ d_RF, float scale )
{   
    __shared__ float smem[8*560];
    __shared__ float2 s_RF[16];
    float2 c[16], d[17];
...
__global__ void dk_xfft32x32_c2r_grad_s5( __half* d_r, const float2* __restrict__ d_c, const float* __restrict__ d_RF, float scale )
{   
    __shared__ float smem[8*560];
    __shared__ float2 s_RF[16];
    float2 c[16], d[17];
